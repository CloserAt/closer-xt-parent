...
public class DirectiveHandler {
    ...
    public String getString(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converString(getModel(name));
    }

    public Integer getInteger(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converInteger(getModel(name));
    }

    public Short getShort(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converShort(getModel(name));
    }

    public Long getLong(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converLong(getModel(name));
    }

    public Double getDouble(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converDouble(getModel(name));
    }

    public String[] getStringArray(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converStringArray(getModel(name));
    }

    public Boolean getBoolean(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converBoolean(getModel(name));
    }

    public Date getDate(String name) throws TemplateModelException {
        return com.closer.xt.admin.template.TemplateModelUtils.converDate(getModel(name));
    }
    ...
    public String getContextPath() {
        String ret = null;
        try {
            ret =  com.closer.xt.admin.template.TemplateModelUtils.converString(getEnvModel("base"));
    ...
    public abstract static class BaseMethod implements TemplateMethodModelEx {
        ...
        public String getString(List<TemplateModel> arguments, int index) throws TemplateModelException {
            return com.closer.xt.admin.template.TemplateModelUtils.converString(getModel(arguments, index));
        }

        public Integer getInteger(List<TemplateModel> arguments, int index) throws TemplateModelException {
            return com.closer.xt.admin.template.TemplateModelUtils.converInteger(getModel(arguments, index));
        }

        public Long getLong(List<TemplateModel> arguments, int index) throws TemplateModelException {
            return com.closer.xt.admin.template.TemplateModelUtils.converLong(getModel(arguments, index));
        }

        public Date getDate(List<TemplateModel> arguments, int index) throws TemplateModelException {
            return com.closer.xt.admin.template.TemplateModelUtils.converDate(getModel(arguments, index));
        }
