...
public abstract class TemplateDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map parameters,
        ...
        try {
            execute(new com.closer.xt.admin.template.DirectiveHandler(env, parameters, loopVars, body));
        } catch (IOException e) {
            throw e;
        } catch (Exception e) {
    ...
    abstract public void execute(com.closer.xt.admin.template.DirectiveHandler handler) throws Exception;
}